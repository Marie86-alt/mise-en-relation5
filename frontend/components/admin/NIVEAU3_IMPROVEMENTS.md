                                              ...
                                              - - Nouveaux styles ajoutés sans modifier les anciens
                                                - - Pas de breaking changes
                                                  - - Migrations progressives possibles
                                                    ...
                                                    2. 2. **Ombres**: Respectez la hiérarchie (light → medium → deep → elevated)
                                                       3. 3. **Espacement**: Utilisez les constantes, jamais de valeurs hardcodées
                                                          4. 4. **Icônes**: Choisissez small/medium/large selon le contexte
                                                             5. 5. **Hover States**: Toujours inclure `...shadows.deep` pour feedback visuel
                                                               
                                                                6. ---
                                                               
                                                                7. ## 🚀 Prochaines Étapes
                                                               
                                                                8. - **Niveau 4** pourrait inclure:
